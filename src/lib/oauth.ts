...
export const APP_ORIGIN_BR = 'https://www.cotarme.com.br';
...
// Destino escolhido antes de sair para o provedor OAuth.
export const POST_LOGIN_NEXT_KEY = 'cotarme_post_login_next';

export const rememberPostLogin = (next: string) => {
  try {
